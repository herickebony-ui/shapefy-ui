...
// Detecta duplicação em sequência da child table (bug intermitente do backend
// que copiava as perguntas 2x). Mesma lógica do AnamneseViewerModal.
