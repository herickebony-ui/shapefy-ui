...
import {
  ...
  Inbox, CalendarClock, FileEdit, FileQuestion, Bookmark, Images,
} from 'lucide-react'
...
const NAV_ITEMS = [
  ...
  { id: 'evolucao-peso',        label: 'Peso do Aluno',                icon: TrendingUp,      path: '/evolucao/peso' },
  { id: 'evolucao-fotos',       label: 'Fotos do Aluno',               icon: Images,          path: '/evolucao/fotos' },
